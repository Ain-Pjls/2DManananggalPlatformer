...
public class MovingPlatform : MonoBehaviour
{
    ...
    private void OnDrawGizmos() // Adds highlight markings to the invisible gizmo ranges and detectors in the editor (THIS TOOL IS JUST FOR VISUALIZING OR DEBUGGING)
    {
        ...
        // DRAWING COMMANDS
        //Gizmos.DrawWireSphere(pointA.transform.position, gizmoSize); // Draws a red wireframe sphere at pointA's position
        //Gizmos.DrawWireSphere(pointB.transform.position, gizmoSize); // Draws a red wireframe sphere at pointB's position
        //Gizmos.DrawLine(pointA.transform.position, pointB.transform.position); // Draws a red line wire starting at pointA's postion up to pointB's position
